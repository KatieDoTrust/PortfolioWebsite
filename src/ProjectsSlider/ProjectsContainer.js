...
function ProjectsContainer() {
    ...
    const projectData = [
      ...
      {id: 2, title: 'Gym Management', content: 'Python project at CodeClan. Full stack app for gym employees to manage bookings.', imgUrl: '/python_screenshot.jpeg', projectUrl: "https://github.com/katiebooth/Python_Flask_Project_Gym_App"},
      {id: 3, title: 'Biology Education', content: 'Javascript project at CodeClan. Full stack education app with quizzes and comment board.', imgUrl: '/js_project_screenshot.jpeg', projectUrl:"https://github.com/katiebooth/Javscript_Education_App"},
